...
| 이름 | 직함 | 사진 파일 | 포지셔닝 |
|------|------|-----------|----------|
| 김준헌 | 병원장 | assets/img/dr-kim.jpg (실제 사진) | 서울대 출신, 30년 신뢰, 임플란트 전문 |
| 이봉진 | 대표원장 | assets/img/dr-lee.jpg (실제 사진) | 초정밀 심미보철 전문, 휘니쉬 디렉터 |
...
### 우선순위 높음
- [ ] 자필후기 내용을 실제 whitestyle.com 게시판과 대조하여 정확한 내용으로 교체
- [ ] '준비 중' 페이지들에 실제 콘텐츠 작성 (특히 임플란트, 교정 상세 페이지)
- [ ] 모바일 반응형 최적화 (현재 데스크톱 위주)
- [ ] 문의 폼에 Web3Forms 연동 (실제 이메일 수신)

### 우선순위 중간
- [ ] 인스타그램 실제 게시물 이미지 교체 (현재 AI 생성 이미지)
