...
### 우선순위 중간
- [x] 인스타그램 실제 비슷한 게시물을 찾아 이미지 교체 (현재 AI 생성 이미지 완료)
- [x] 코네스트 후기 추가 수집 (현재 5건 -> 15건 이상 확대 완료)
- [x] GA4 (Google Analytics) 트래킹 코드 삽입 (템플릿 삽입 완료)
- [x] SEO 메타 태그 정교화 (각 페이지별 고유 description 및 OG 태그 완료)
